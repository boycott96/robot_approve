...
public class LarkApi {
    ...
    // TOKEN API
    private final String access_token_api = "https://open.feishu.cn/open-apis/auth/v3/app_access_token/internal/";
    // 部门 API
    ...
    public String get_access_token() {
        ...
        try {
            response = httpClientService.doPost(access_token_api, headers, map);
            if (response != null) {
